...
``C:\Users\christopher.mcgee\``. The notable exception to this is
``C:\Product Templates (Master)\`` which, unsurprisingly, contains all
...
```~\dev\`` <#32-dev>`__, ```~\Sites\`` <#33-sites>`__, and
```~\Documents`` <#34-documents>`__.

3.2. Dev
~~~~~~~~

In here are most of my development projects and helpers. I had planned
to incorporate ```~\Sites\`` <#33-sites>`__ in here at some point, but
...
+======================+==================================================================================================+
| ``++Certificates``   | Contains the latest SSL certificates that Shawn purchases for all of our sites.                  |
+----------------------+--------------------------------------------------------------------------------------------------+
| ``++Purchases``      | Downloads of purchased software packages that I use for some of our sites. Mostly just backup.   |
+----------------------+--------------------------------------------------------------------------------------------------+
| ``++WordPress``      | More downloads of purchases, this time for our upcoming AA WordPress site.                       |
+----------------------+--------------------------------------------------------------------------------------------------+
| ``aa2021``           | Old, static HTML/CSS American Accents site.                                                      |
+----------------------+--------------------------------------------------------------------------------------------------+
| ``aa2021-assets``    | Static assets for the new WordPress AA site.                                                     |
+----------------------+--------------------------------------------------------------------------------------------------+
...
| Directory                   | Purpose                                                                                                                            |
+=============================+====================================================================================================================================+
| ``1Password*.1pif``         | Has all the login credentials I use at Sky in `1Password <https://1password.com/>`__ format.                                       |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------+
| ``adobe-scripts``           | Explained in `2.4. Template-Making Scripts <#24-template-making-scripts>`__ and in further detail `below <#331-adobe-scripts>`__   |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------+
| ``Bluehost``                | Some invoices from our failed attempted to use Bluehost as our website host.                                                       |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------+
| ``db-backup``               | For storing backups of our various databases. It's rather disorganized, sorry.                                                     |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------+
| ``employee test folder``    | For potential Art Department employees.                                                                                            |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------+
| ``JavaScript Native[…]``    | Course by Davide Barranca for creating native applications for Photoshop. Probably deprecated by now.                              |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------+
| ``ShareX``                  | Stores screenshots and screencaptures made with ShareX.                                                                            |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------+
| ``SyncBackFree Profiles``   | Backups of the profiles (tasks) used in SyncBackFree.                                                                              |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------+
| ``temp``                    | Used primarily for making InDesign templates.                                                                                      |
+-----------------------------+------------------------------------------------------------------------------------------------------------------------------------+
...
| File Name                                        | Purpose                                                                                                                                      |
+==================================================+==============================================================================================================================================+
| ``1Password*.csv``                               | Has all the login credentials I use at Sky in CSV format.                                                                                    |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``2020 American Accents Catalog.pdf``            | This and the next 5 items are symlinks/shortcuts to server files for quick and easy access.                                                  |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``AA Gross & Net Pricing``                       |                                                                                                                                              |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``Absence request form``                         |                                                                                                                                              |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``Item #.lnk``                                   |                                                                                                                                              |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``Item Specifications.lnk``                      |                                                                                                                                              |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``MailingBoxes-PiecesPerSheet``                  |                                                                                                                                              |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``Adobe*.ps1``                                   | PowerShell scripts to manage Adobe Updates.                                                                                                  |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``AEM-Sites-Buyers-Guide.pdf``                   | Adobe guide on how to pick the best content manager service.                                                                                 |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``Allworx9224doc.pdf``                           | Instructions for the phone system.                                                                                                           |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``CheatSheet-TissuePaper.pdf``                   | Instructions for how to Proof a Tissue Paper job.                                                                                            |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``clip.exe``                                     | Used to copy WSL things to the Windows clipboard.                                                                                            |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``colortest.ps1``                                | A test to see how colors appear on PowerShell.                                                                                               |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``D-BSL-SMOOTH``                                 | Backup of a deprecated item, the Smooth Beverage Sleeve.                                                                                     |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``Delete_Job.sql``                               | Template for deleting an Order from the ``sky_schedule`` database.                                                                           |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``FindLineItemsWithoutOrders.sql``               | SQL script to find any orphaned Line Items in the db.                                                                                        |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``Get_All_By_Job_Id.sql``                        | **DEPRECATED**. To get all the info from the db on a given Order.                                                                            |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``get_line_item_and_artworks_by_order_id.sql``   | Same as above, but leaves out the Order info.                                                                                                |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``GetAllByJobNumber.sql``                        | To get all the info from the db on a given Order.                                                                                            |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``Free Space.xlsx``                              | A calculator for seeing when the server would run out of disk space.                                                                         |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``IT Cheat Sheet.xlsx``                          | **OUTDATED**. A very old version of a list of all computers and their logins.                                                                |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``ItemID_2019_v10.xlsx``                         | A scratch board for testing out what Product Numbers would look like.                                                                        |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``P26208 - Exile``                               | PO for the Exile (imagesetter) software upgrade.                                                                                             |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``PCs-*.txt``                                    | List of PCs that are used by ``psshutdown`` to, well, shut down those PCs.                                                                   |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``PrepCenter-Instructions-PC.pdf``               | Instructions on how to use PrepCenter on Windows.                                                                                            |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``RegExp-01 - Tables to Divs.txt``               | Copy-paste-able Regular Expressions to convert the old table-style thumbnails to the newer div-style thumbnails on the old static AA site.   |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``skyfs.rdp``                                    | Remote Desktop connection to SKYFS.                                                                                                          |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``vscode-user-settings.json``                    | Backup of user settings I made before wiping VS Code.                                                                                        |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``White-Ink-Examples.pdf``                       | Instructions on how to properly handle white ink.                                                                                            |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
| ``WinSCP.ini``                                   | Backup of FTP sites used in WinSCP.                                                                                                          |
+--------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------+
...
| Directory Name                       | Purpose                                                                                           |
+======================================+===================================================================================================+
| ``Acrobat``                          | Contains the main 6 Acrobat scripts that are used in the Proof/Output scripts.                    |
+--------------------------------------+---------------------------------------------------------------------------------------------------+
| ``Illustrator\Downloaded``           | A bunch of Illustrator scripts that I've downloaded which I thought might be useful.              |
+--------------------------------------+---------------------------------------------------------------------------------------------------+
| ``Illustrator\Learning``             | Where all of my small unit tests are made before they are incorporated into larger scripts.       |
+--------------------------------------+---------------------------------------------------------------------------------------------------+
| ``Illustrator\++LargestPathArea``    | One of two useful scripts for Illustrator for shaped products.                                    |
+--------------------------------------+---------------------------------------------------------------------------------------------------+
| ``Illustrator\++ResizeToArea``       | The second of those useful scripts.                                                               |
+--------------------------------------+---------------------------------------------------------------------------------------------------+
| ``Illustrator\[the rest]``           | Everything else are mostly just tests and experiments.                                            |
+--------------------------------------+---------------------------------------------------------------------------------------------------+
| ``InDesign\create-downloadable-*``   | See the above section for more info. These are used often.                                        |
+--------------------------------------+---------------------------------------------------------------------------------------------------+
| ``InDesign\Learning``                | Like with Illustrator, small tests done in here so I can learn.                                   |
+--------------------------------------+---------------------------------------------------------------------------------------------------+
| ``InDesign\[the rest]``              | The rest are smaller scripts and experiments that are used rarely, if at all anymore.             |
+--------------------------------------+---------------------------------------------------------------------------------------------------+
| ``Photoshop``                        | Two experiments for batch renaming layers and for creating a ``@1.5x`` version of retina files.   |
+--------------------------------------+---------------------------------------------------------------------------------------------------+

3.5. ``sky-open-template``
~~~~~~~~~~~~~~~~~~~~~~~~~~

One dev project that doesn't exist in ``~\dev\`` is
```sky-open-template`` <https://github.com/skyunlimitedinc/sky-open-template>`__.
This can be found at
``C:\Program Files (x86)\Common Files\Adobe\CEP\extensions\com.skyunlimitedinc.open-template``.
